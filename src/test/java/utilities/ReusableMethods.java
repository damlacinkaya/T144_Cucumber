...
public class ReusableMethods {
    ...
    public static void switchWindowByUrl(WebDriver driver, String hedefUrl) {
        ...
        for (String eachWhd : acikWindowlarinWhdSeti
            ...
            //öce bizim oglanın getrdigi Whd ile bir window'a geçiş yapalim
    ...
    public static void getFullScreenshot(WebDriver driver, String screenshotIsmi) {
        ...
        File tumSayfaSS = new File("target/ekranGoruntuleri/" + screenshotIsmi + "tumSayfaSS.png");
    ...
    public static void getFullScreenshot(WebDriver driver) {
        // dosya ismilerine tarih etiketi ekleyelim
        // .... 240829114043 gibi bir etiket eklemek dosya ismini benzersiz yapar son altı karakter saat dakika saniye

        LocalDateTime zaman = LocalDateTime.now();
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyMMddHHmmss");
        String tarihEtiketi = zaman.format(dateTimeFormatter); //240829114043
